(function(ext) {
    ...
    var connected = false;
    var wsc = new WebSocket('ws://133.1.177.101:4649/Echo', ['echo-protocol']);
    wsc.binaryType = 'arraybuffer';
    wsc.onmessage = function (e) {
	console.log('received: ' + connected);
	var inputData = new Uint8Array(e.data);
    ...
    var device = {name: "wsc", pin: 4, val: 0}; // null
    var inputData = null;
    ...
    ScratchExtensions.register('Arduino-Ether', descriptor, ext);
